...
## Releases
### 1/23/23 Release Notes
- Added support for GitHub back sync
- Added support for Jira and Linear history workflows 

### 1/5/23 Release Notes
- Connector infrastructure revamp
- Fix deleting Linear connector flow

### 12/15/22 Release Notes
- Added support for advanced rendering for Dashboards 
- Improvements to setting default parameter values in Dashboards
