...
To run a query, type in a query and select the query you wish to run in the editor experience and then hit run or “Shift + Enter”. You can find samples here: [Samples (notion.site)](https://docs.intunedhq.com/kusto)
